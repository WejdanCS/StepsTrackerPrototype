              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                if (snapshot.hasData) {
                        ...
                        // for (var doc in snapshot.data.docs) {
                          // var data = doc;
                          _rewardController.addRewardInfo(snapshot);
                          // var reward=Reward(
                          //     rewardId:data.id,
                                ...
                                return
                                    Card(
                                        ...
                                        children: [
                                          Stack(
                                            children: [
                                              Image.network(_rewardController.rewards[index].rewardImage,fit: BoxFit.fill,width: _width,),
                                              Positioned(
                                                  left: _width*0.01,
                                                  top: _height*0.01,
                                                  //ToDo: check PartnerName and return it here ..
                                                  child: Chip(label: Text("Jarir",style: TextStyle(color: Colors.white,)),backgroundColor: Constant.primaryColor,)),
                                              Positioned(
                                                right: _width*0.01,
                                                top: _height*0.01,
                                                child: CircleAvatar(
                                                  ...
                                                  child:Padding(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(_rewardController.rewards[index].points.toString(),style: TextStyle(color: Colors.white,fontStyle: FontStyle.normal,fontWeight: FontWeight.bold),),
                                                        Text("points",style: TextStyle(fontSize: 10,color: Colors.white),)
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                           ...
                                           Text(_rewardController.rewards[index].rewardName),
                                          SizedBox(height: _height*0.01,),
                                          Text(_rewardController.rewards[index].rewardDesc),
